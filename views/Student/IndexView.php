...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand ps-3" href="#">Portal Estudiante</a>
...
<div id="layoutSidenav">
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            require_once(BASE_PATH . '/views/partials/menuStudent.php');
            ?>
        </nav>
    </div>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Mi Portal</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Dashboard del Estudiante</li>
                </ol>

                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <h2 class="h4">Hola, <strong><?php echo htmlspecialchars($dashboard['name'] ?? 'Estudiante'); ?></strong></h2>
                        <p class="mb-0 text-muted">Bienvenido a tu portal de estudiante.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Aquí iría la lista de cursos en los que estás inscrito...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Aquí iría el resumen de tus calificaciones...</p>
                            </div>
                        </div>
                    </div>
                </div>
